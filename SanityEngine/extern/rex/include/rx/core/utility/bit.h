...
inline Size bit_pop_count(Uint32 _bits) {
  ...
  static constexpr const Uint32 k_m1{0x55555555}; // binary: 1 zeros, 1 ones repeating: 01010101...
  static constexpr const Uint32 k_m2{0x33333333}; // binary: 2 zeros, 2 ones repeating: 00110011...
  static constexpr const Uint32 k_m4{0x0f0f0f0f}; // binary: 4 zeros, 4 ones repeating: 00001111...
  static constexpr const Uint32 k_h0{0x01010101}; // sum of 256 to the power of 0,1,2,3...
...
inline Size bit_pop_count(Uint64 _bits) {
  // hamming weight to count set bits; 17 arithmetic ops on x86_64
  static constexpr const Uint64 k_m1{0x5555555555555555}; // binary: 1 zeros, 1 ones repeating: 01010101...
  static constexpr const Uint64 k_m2{0x3333333333333333}; // binary: 2 zeros, 2 ones repeating: 00110011...
  static constexpr const Uint64 k_m4{0x0f0f0f0f0f0f0f0f}; // binary: 4 zeros, 4 ones repeating: 00001111...
  static constexpr const Uint64 k_h0{0x0101010101010101}; // sum of 256 to the power of 0,1,2,3...
