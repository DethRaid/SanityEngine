...
typedef WrenForeignMethodFn (*WrenBindForeignMethodFn)(
    WrenVM* vm, const char* module_name, const char* className, bool isStatic, const char* signature);
...
typedef void (*WrenErrorFn)(WrenVM* vm, WrenErrorType type, const char* module_name, int line, const char* message);
...
typedef WrenForeignClassMethods (*WrenBindForeignClassFn)(WrenVM* vm, const char* module_name, const char* className);
...
WrenInterpretResult wrenInterpret(WrenVM* vm, const char* module_name, const char* source);
...
// it in [slot].
void wrenGetVariable(WrenVM* vm, const char* module_name, const char* name, int slot);
