...
#pragma region Autogenerated
    // Autogenerated identifier for this component type. Allows this component to type to be saved to disk
    // ReSharper disable once CppInconsistentNaming
    uint64_t _handle{0};
#pragma endregion
};

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TransformComponent, location, rotation, scale, _handle)
