...
namespace sanity::engine {
    ...
    public:
         ...
         *
         * The new AssetRegistry will scan the given directory and all subdirectories for `.meta` files. The AssetRegistry reads the GUIDs
         * in all those files and builds a map from an asset's GUID to its location on the filesystem. Then, when you actually open an
         * asset, the asset viewer will query this registry for the file paths of all the referenced assets and load them as needed
         */
