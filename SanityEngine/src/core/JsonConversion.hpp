...
#define NLOHMANN_DEFINE_TYPE_INTRUSIVE(Type, ...) \
	friend NLOHMANN_TO_JSON(Type, __VA_ARGS__) \
	friend NLOHMANN_FROM_JSON(Type, __VA_ARGS__)
...
#define NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Type, ...)                                                                                      \
    inline NLOHMANN_TO_JSON(Type, __VA_ARGS__) \
