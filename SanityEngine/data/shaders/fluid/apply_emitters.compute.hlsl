...
void main( uint3 id : SV_DispatchThreadID ) {
	...
	const float3 emitter_to_voxel = id / (fluid_volume.size - 1.f) - fluid_volume.emitter_location.xyz;
	...
	temperature_out[id] = temperature_in[id] + amount;
	...
	reaction_out[id] = reaction_in[id] + amount;
}
